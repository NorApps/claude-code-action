...
export function validateBranchName(branchName: string): void {
  ...
  // Strict whitelist pattern: alphanumeric, @, _ or # start, then alphanumeric/slash/hyphen/underscore/period/hash/plus/comma/at-sign.
  // # is valid per git-check-ref-format and commonly used in branch names like "fix/#123-description",
  //   as well as at the start ("#123-fix") — FotMob branches always start with # per our CI convention.
